...
var COLUMN_MAP = []report.ColumnMap{
    ...
    { Field: "PRIMARY_SPECIALTY", Text: "PRIMARY SPECIALITY" },
    { Field: "PAYMENT_CLASS_CODE", Text: "PAYMENT CLASS" },
    { Field: "DISCHARGE_DATE", Text: "DISCHARGE DATE" },
    { Field: "DISCHARGE_TIME", Text: "DISCHARGE TIME" },

    { Field: "DISCHARGE_REASON", Text: "DISCHARGE REASON" },
    { Field: "DIAGNOSIS_DESC", Text: "DIAGNOSIS DESC" },
    { Field: "ICD10_CODE", Text: "ICD CODE" },
    { Field: "ICD10_DESCRIPTION", Text: "ICD DESC" },
}
